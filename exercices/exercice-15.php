...
/**
 * Exercice 15 — Somme des nombres pairs
 *
 * Demander un nombre entier positif à l'utilisateur,
 * puis afficher les nombres pairs compris entre 1 et ce nombre
...
if (filter_var($nombre, FILTER_VALIDATE_INT) !== false) {
    ...
    if ($nombre <= 0) {
        ...
        // Initialise l'accumulateur de la somme.
        $somme = 0;
        ...
        for ($i = 1; $i <= $nombre; $i++) {
            ...
            // Vérifie si le nombre courant est pair.
            if ($i % 2 === 0) {
        ...
        echo "Somme des nombres pairs : $somme" . PHP_EOL;
    }
